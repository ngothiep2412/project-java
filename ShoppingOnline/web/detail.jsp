            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            <a href="add-to-cart?productID=${PRODUCT.productID}" class="btn btn-outline-dark flex-shrink-0 ms-2" type="button">
                                <i class="bi-cart-fill me-1"></i>
                                Add to cart
                            </a>
                            <a class="btn btn-outline-dark flex-shrink-0 ms-2" type="button">
                                <i class="bi-cart-fill me-1"></i>
                                Buy Now
                            </a>
                        </div>
